...
public:
	...
	void afficherDetection(double distance1, double distance2, double distance3, const char *categorie1, const char *categorie2, const char *categorie3);
	void affichageCatetDist2(const char *categorie1, const char *categorie2, const char *categorie3, const char *dist2);
	void afficherManoeuvre(uint8_t numero);
	void afficherAucuneManoeuvre();
